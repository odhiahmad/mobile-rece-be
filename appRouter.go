...
func (r *appRouter) InitMainRoutes() {
	...
	appRoutes := []appRoutes{
		...
		{
			centerRoutes: handler.NewHistoriesController(r.app.router, r.parse, r.responder, serviceManager.WalletHistoryUseCase()),
			mdw:          nil,
		},
		{
		...
		{
			centerRoutes: handler.NewUserMerchantController(r.app.router, r.parse, r.responder, serviceManager.UserMerchantUseCase()),
			mdw:          nil,
		},
	}
